...
public class usersForm extends javax.swing.JFrame {
    private void reloadList(){
        ...
        String[] friends = Main.model.getUsersNames().toArray(new String[Main.model.getUsersNames().size()]);
    ...
    public usersForm() {
        ...
        ActionListener showBoard = new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                Main.tempUser = Main.model.getUsers().get((friendsList.countComponents()) - (friendsList.getSelectedIndex())+2);
                mainForm.main(null);
                dispose();
            }
        }; 
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Usuarios de JoinMe!");
